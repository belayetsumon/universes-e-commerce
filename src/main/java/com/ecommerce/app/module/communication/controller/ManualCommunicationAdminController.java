...
@Controller
@RequestMapping("/admin/communication/manual")
public class ManualCommunicationAdminController {
    ...
    public ManualCommunicationAdminController(
    ...
    public void common(Model model) {
        ...
        model.addAttribute("manualAudiences", permissionService.allowedAudiences(ManualActorType.ADMIN));
        model.addAttribute("basePath", "/admin/communication/manual");
        model.addAttribute("scope", "admin");
    }

    @GetMapping("/compose")
    public String compose(Model model) {
        permissionService.requireAdminActor();
        prepareCompose(model, new ManualMessageRequest());
        return "admin/communication/manual-compose";
    }
    ...
    public String send(@Valid @ModelAttribute("manualMessage") ManualMessageRequest request,
        ...
        try {
            ...
            return "redirect:/admin/communication/manual/sent";
    ...
    public String inbox(Model model,
        ...
        return "admin/communication/manual-history";
    }
    ...
    public String logs(Model model,
            ...
            @RequestParam(defaultValue = "25") int size) {
        permissionService.requireAdminActor();
        model.addAttribute("page", historyService.findManualLogs(channel, status, q, pageable(page, size)));
        historyModel(model, "logs", channel, status, q);
        return "admin/communication/manual-history";
    }
    ...
    private void prepareCompose(Model model, ManualMessageRequest request) {
        ...
        model.addAttribute("customerOptions", audienceResolverService.selectableCustomersForAdmin());
        model.addAttribute("vendorOptions", audienceResolverService.selectableVendorsForAdmin());
    }
