...
public class MultiLavelRateSettings {
    ...
    public MultiLavelRateSettings() {
    }

    public MultiLavelRateSettings(Long id, LevelEnum level, String createdBy, LocalDateTime created, String modifiedBy, LocalDateTime modified) {
        this.id = id;
        this.level = level;
