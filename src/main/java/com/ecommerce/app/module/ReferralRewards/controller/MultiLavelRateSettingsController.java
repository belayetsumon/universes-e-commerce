...
public class MultiLavelRateSettingsController {
    ...
    @PostMapping("/save")
    public String save(@Valid @ModelAttribute MultiLavelRateSettings lavelRateSettings,
    ...
    public String editForm(@PathVariable Long id, Model model, RedirectAttributes redirectAttributes) {
        Optional<MultiLavelRateSettings> optional = lavelRateSettingsRepository.findById(id);
        if (optional.isEmpty()) {
