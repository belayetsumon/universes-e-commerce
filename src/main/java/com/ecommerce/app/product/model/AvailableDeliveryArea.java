...
public class AvailableDeliveryArea {
    ...
    public AvailableDeliveryArea(Long id, Product product, String description, String createdBy, LocalDateTime created, String modifiedBy, LocalDateTime modified) {
        this.id = id;
